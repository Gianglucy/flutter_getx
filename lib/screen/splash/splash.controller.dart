...
class SplashController extends GetxController with WidgetsBindingObserver {
  ...
  getData() async {
    ...
    var res = await _userRepo.loginManual(
        ...
        password: 'Gumi7393',
        fcmToken:
            "cuvymcfHxE7SoirxzhU59Q:APA91bFEdGy7304leIOoosXT5qhOLxB2vdbvaJc2hWc3TTgu_yRlyPmPPfb-ww1OYaECh6uKt2QoxDm8fOfWfAmH1ujBoYd5AhD20wvTqsLd8Mf7a394GD6xwpYXwRz2rIX08HYPe3_h");
